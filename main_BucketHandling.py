...
def droneFiles():
    ...
    global inputBucket
    inputBucket = "innovationLabInputBucket"
    global outputBucket
    outputBucket = "innovationLabOutputBucket"
...
def updateFusion():
    ...
    fusionUrl = "https://fa-ewok-fusionappsqa.fa.ocs.oc-test.com/fscmRestApi/resources/11.13.18.05/cycleCountSequenceDetails"
    user = "Jim.Smith"
    password = "Au6`j1yctlva"
    payload = json.dumps({
